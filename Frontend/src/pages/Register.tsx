...
export default function Register() {
  ...
  const fields = [
    ...
    { key: "confirm", label: "Confirmar contraseña", icon: Lock, type: "password", placeholder: "••••••••" },
  ];
      ...
      >
        ...
        <div className="glass-surface p-8 shadow-lg" style={{ boxShadow: "var(--shadow-card)" }}>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              {loading ? <Spinner size="sm" className="border-primary-foreground/30 border-t-primary-foreground" /> : "Registrarse"}
            </Button>
          </form>
